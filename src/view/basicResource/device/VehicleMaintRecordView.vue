  ...
  data () {
    return {
      ...
      formData: {
        ...
        groupEdit: true,
        groupKey: ['vehicleId', 'maintenanceType', 'nouseTimeRange'],
        groupKeyUrl: 'basicdata/VehicleMaintenanceRecord/checkOne',
        formData: [
          ...
          {key: 'nouseTimeRange', key1: 'beginTime', key2: 'endTime', label: '车辆维护时间区间', label1: '开始/加油时间', label2: '结束时间', type: 'dateRangePicker', required: 1, requiredInfo: '开始/加油时间不能为空', dateType: 'datetime', format: 'yyyy-MM-dd HH:mm', valueFormat: 'yyyy-MM-dd HH:mm', class: 'auto-width'},
