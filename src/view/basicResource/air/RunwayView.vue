...
export default {
  ...
  data () {
    return {
      // 基础路径
      baseUrl: 'airportResource/runway',
      formData: {
        title: '新增',
        visible: false,
        inline: true,
        ...
        key: 'runwayNo',
        formData: [
          {key: 'runwayNo', label: '跑道编号', type: 'input', maxlength: 20},
          {key: 'isUseable', label: '是否可用', type: 'tabs', tabsKey: 'isYOrN'},
          {key: 'timeRange', key1: 'nouseSTime', key2: 'nouseETime', label: '不可用时间区间', label1: '开始时间', label2: '结束时间', type: 'dateRangePicker', dateType: 'datetime', format: 'yyyy-MM-dd HH:mm:ss', valueFormat: 'yyyy-MM-dd HH:mm:ss', class: 'auto-width'},
